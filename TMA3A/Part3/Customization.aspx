    ...
    <form id="form1" runat="server">
      <div class="banner">
        ...
        <div id="partsGroup">
            ...
            <asp:Image ID="Image1" runat="server" />     <div><asp:Label runat="server" ID="compLabel"></asp:Label></div>
            <div><asp:Label runat="server" ID="price"></asp:Label></div>
            <div><asp:Image ID="ComputerImg" runat="server" /></div>
            <div style="display:flex;width:100%;">
                <asp:Button ID="cartBtn" runat="server" Text="Add to cart" CssClass="button" OnClick="cartBtn_Click" />
                <div style="align-items:flex-end; display:inline-flex;"><asp:Label ID="totalPrice" runat="server" ></asp:Label></div>
            </div>
            <div class ="partOptions">
               
                <div>
                    <asp:DropDownList ID="selectCpu" runat="server" AutoPostBack="true" onselectedindexchanged="selectDisplay_SelectedIndexChanged">
                    ...
                    <asp:Label ID="CpuLabel" runat="server" ></asp:Label>
                </div>
                 <div>
                     <asp:DropDownList ID="selectDisplay" runat="server" AutoPostBack="true" onselectedindexchanged="selectDisplay_SelectedIndexChanged">
                 ...
                 <div>
                    <asp:DropDownList ID="selectHd" runat="server" AutoPostBack="true" onselectedindexchanged="selectDisplay_SelectedIndexChanged">
                     ...
                     <asp:Label ID="HdLabel" runat="server" ></asp:Label>
                </div>
                 <div>
                    <asp:DropDownList ID="selectRam" runat="server" AutoPostBack="true" onselectedindexchanged="selectDisplay_SelectedIndexChanged">
                     ...
                     <asp:Label ID="RamLabel" runat="server"></asp:Label>
                </div>
                 <div>
                     <asp:DropDownList ID="selectOs" runat="server" AutoPostBack="true" onselectedindexchanged="selectDisplay_SelectedIndexChanged">
                     ...
                     <asp:Label ID="OsLabel" runat="server" ></asp:Label>
                </div>
                <div>
                    <asp:DropDownList ID="computerList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="computerList_SelectedIndexChanged"/>
                </div>
            </div>
        </div>
